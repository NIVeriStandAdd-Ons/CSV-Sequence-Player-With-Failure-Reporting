...
<Project Type="Project" LVVersion="11008008">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Analysis" Type="Folder">
			<Item Name="Channel path to TDMS Group and Channel.vi" Type="VI" URL="../Analysis/Channel path to TDMS Group and Channel.vi"/>
			<Item Name="Find Index of Timestamps.vi" Type="VI" URL="../Analysis/Find Index of Timestamps.vi"/>
			<Item Name="Read Actual Values From Log File.vi" Type="VI" URL="../Analysis/Read Actual Values From Log File.vi"/>
			<Item Name="Read All Actual Values From Log File.vi" Type="VI" URL="../Analysis/Read All Actual Values From Log File.vi"/>
		</Item>
		<Item Name="Controls" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Test Data Record.ctl" Type="VI" URL="../Controls/Test Data Record.ctl"/>
			<Item Name="DVR of CSV Tests Data.ctl" Type="VI" URL="../Controls/DVR of CSV Tests Data.ctl"/>
			<Item Name="CSVs Tests Data.ctl" Type="VI" URL="../Controls/CSVs Tests Data.ctl"/>
			<Item Name="Test Column Data.ctl" Type="VI" URL="../Controls/Test Column Data.ctl"/>
			<Item Name="Top Level Control.ctl" Type="VI" URL="../Controls/Top Level Control.ctl"/>
			<Item Name="ListBox Test Record.ctl" Type="VI" URL="../Controls/ListBox Test Record.ctl"/>
			<Item Name="Silver Sequence State.ctl" Type="VI" URL="../Controls/Silver Sequence State.ctl"/>
			<Item Name="Silver Sequence Time.ctl" Type="VI" URL="../Controls/Silver Sequence Time.ctl"/>
			<Item Name="DPL Request.ctl" Type="VI" URL="../Controls/DPL Request.ctl"/>
			<Item Name="Fail Rows.ctl" Type="VI" URL="../Controls/Fail Rows.ctl"/>
			<Item Name="Stim Player Data.ctl" Type="VI" URL="../Controls/Stim Player Data.ctl"/>
			<Item Name="Options.ctl" Type="VI" URL="../Controls/Options.ctl"/>
			<Item Name="Options DVR.ctl" Type="VI" URL="../Controls/Options DVR.ctl"/>
			<Item Name="Excel Refs.ctl" Type="VI" URL="../Controls/Excel Refs.ctl"/>
		</Item>
		<Item Name="Data Processing Loop" Type="Folder">
			<Item Name="Create Failure Data.vi" Type="VI" URL="../Data Processing Loop/Create Failure Data.vi"/>
			<Item Name="Create Graph Data.vi" Type="VI" URL="../Data Processing Loop/Create Graph Data.vi"/>
			<Item Name="Create Log Data.vi" Type="VI" URL="../Data Processing Loop/Create Log Data.vi"/>
			<Item Name="Data Processing Loop.vi" Type="VI" URL="../Data Processing Loop/Data Processing Loop.vi"/>
			<Item Name="Generate Log Data.vi" Type="VI" URL="../Data Processing Loop/Generate Log Data.vi"/>
			<Item Name="Get Channel Actual Values.vi" Type="VI" URL="../Data Processing Loop/Get Channel Actual Values.vi"/>
			<Item Name="Log CSV PassFail Data.vi" Type="VI" URL="../Data Processing Loop/Log CSV PassFail Data.vi"/>
			<Item Name="Process Test Record.vi" Type="VI" URL="../Data Processing Loop/Process Test Record.vi"/>
		</Item>
		<Item Name="GUI Loop" Type="Folder">
			<Item Name="Excel Import" Type="Folder">
				<Item Name="Close Excel File.vi" Type="VI" URL="../GUI Loop/Excel Import/Close Excel File.vi"/>
				<Item Name="Filter Names.vi" Type="VI" URL="../GUI Loop/Excel Import/Filter Names.vi"/>
				<Item Name="Open Excel File.vi" Type="VI" URL="../GUI Loop/Excel Import/Open Excel File.vi"/>
				<Item Name="Save Specific Worksheet as CSV.vi" Type="VI" URL="../GUI Loop/Excel Import/Save Specific Worksheet as CSV.vi"/>
				<Item Name="Select Desired Excel Worksheets.vi" Type="VI" URL="../GUI Loop/Excel Import/Select Desired Excel Worksheets.vi"/>
			</Item>
			<Item Name="About.vi" Type="VI" URL="../GUI Loop/About.vi"/>
			<Item Name="Add CSVs to Test List.vi" Type="VI" URL="../GUI Loop/Add CSVs to Test List.vi"/>
			<Item Name="Clear Specific Error.vi" Type="VI" URL="../GUI Loop/Clear Specific Error.vi"/>
			<Item Name="Delete.vi" Type="VI" URL="../GUI Loop/Delete.vi"/>
			<Item Name="Detect Items Being Dragged.vi" Type="VI" URL="../GUI Loop/Detect Items Being Dragged.vi"/>
			<Item Name="Enable RTM Delete Logic.vi" Type="VI" URL="../GUI Loop/Enable RTM Delete Logic.vi"/>
			<Item Name="Find Rows of Dragged Items.vi" Type="VI" URL="../GUI Loop/Find Rows of Dragged Items.vi"/>
			<Item Name="Find Selected CSVs From List.vi" Type="VI" URL="../GUI Loop/Find Selected CSVs From List.vi"/>
			<Item Name="Fix Coloring Offset.vi" Type="VI" URL="../GUI Loop/Fix Coloring Offset.vi"/>
			<Item Name="Get Error from DVR.vi" Type="VI" URL="../GUI Loop/Get Error from DVR.vi"/>
			<Item Name="Get Options from DVR.vi" Type="VI" URL="../GUI Loop/Get Options from DVR.vi"/>
			<Item Name="Get Path&amp;PassFail from DVR.vi" Type="VI" URL="../GUI Loop/Get Path&amp;PassFail from DVR.vi"/>
			<Item Name="Get Signal Names from DVR.vi" Type="VI" URL="../GUI Loop/Get Signal Names from DVR.vi"/>
			<Item Name="Import CSV Files.vi" Type="VI" URL="../GUI Loop/Import CSV Files.vi"/>
			<Item Name="Init Options Dialog.vi" Type="VI" URL="../GUI Loop/Init Options Dialog.vi"/>
			<Item Name="Options.vi" Type="VI" URL="../GUI Loop/Options.vi"/>
			<Item Name="Remove Recieved Test From Running List.vi" Type="VI" URL="../GUI Loop/Remove Recieved Test From Running List.vi"/>
			<Item Name="Remove Selected Items From Lists.vi" Type="VI" URL="../GUI Loop/Remove Selected Items From Lists.vi"/>
			<Item Name="Replace or Append Test Data DVR.vi" Type="VI" URL="../GUI Loop/Replace or Append Test Data DVR.vi"/>
			<Item Name="Revert Running Test Colors.vi" Type="VI" URL="../GUI Loop/Revert Running Test Colors.vi"/>
			<Item Name="RunTimeMenu.rtm" Type="Document" URL="../GUI Loop/RunTimeMenu.rtm"/>
			<Item Name="Search DVRs for CSV Path.vi" Type="VI" URL="../GUI Loop/Search DVRs for CSV Path.vi"/>
			<Item Name="Set Options to DVR.vi" Type="VI" URL="../GUI Loop/Set Options to DVR.vi"/>
			<Item Name="Set Running Tests to Color.vi" Type="VI" URL="../GUI Loop/Set Running Tests to Color.vi"/>
			<Item Name="Sort CSV Array.vi" Type="VI" URL="../GUI Loop/Sort CSV Array.vi"/>
			<Item Name="Update RTM.vi" Type="VI" URL="../GUI Loop/Update RTM.vi"/>
			<Item Name="Write Config File.vi" Type="VI" URL="../GUI Loop/Write Config File.vi"/>
		</Item>
		<Item Name="Sequence Construction" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Construct RT Seq Top Level.vi" Type="VI" URL="../Sequence Construction/Construct RT Seq Top Level.vi"/>
			<Item Name="Construct RT Seq and Insert Log Trigger.vi" Type="VI" URL="../Sequence Construction/Construct RT Seq and Insert Log Trigger.vi"/>
			<Item Name="Query &amp; Delete RTSeq Test Data.vi" Type="VI" URL="../Sequence Construction/Query &amp; Delete RTSeq Test Data.vi"/>
			<Item Name="Fetch Double Variable Value.vi" Type="VI" URL="../Sequence Construction/Fetch Double Variable Value.vi"/>
			<Item Name="Search Variables for Identifier.vi" Type="VI" URL="../Sequence Construction/Search Variables for Identifier.vi"/>
			<Item Name="Fetch Parameter Default Assignments.vi" Type="VI" URL="../Sequence Construction/Fetch Parameter Default Assignments.vi"/>
		</Item>
		<Item Name="Sequence Play" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Create Stimulus Session.vi" Type="VI" URL="../Sequence Play/Create Stimulus Session.vi"/>
			<Item Name="Alias or Channel Lookup.vi" Type="VI" URL="../Sequence Play/Alias or Channel Lookup.vi"/>
			<Item Name="Start Log and Sequence.vi" Type="VI" URL="../Sequence Play/Start Log and Sequence.vi"/>
			<Item Name="Stop Log and Sequence.vi" Type="VI" URL="../Sequence Play/Stop Log and Sequence.vi"/>
		</Item>
		<Item Name="Stim Loop" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Stimulus Player Loop v2.vi" Type="VI" URL="../Stim Loop/Stimulus Player Loop v2.vi"/>
			<Item Name="WRAPPER Create Stimulus Session.vi" Type="VI" URL="../Stim Loop/WRAPPER Create Stimulus Session.vi"/>
			<Item Name="WRAPPER Start Log and Sequence.vi" Type="VI" URL="../Stim Loop/WRAPPER Start Log and Sequence.vi"/>
			<Item Name="Send CSV Started Message.vi" Type="VI" URL="../Stim Loop/Send CSV Started Message.vi"/>
			<Item Name="WRAPPER Construct RT Seq Top Level.vi" Type="VI" URL="../Stim Loop/WRAPPER Construct RT Seq Top Level.vi"/>
			<Item Name="Check ToStim Queue.vi" Type="VI" URL="../Stim Loop/Check ToStim Queue.vi"/>
			<Item Name="Running Event Handler.vi" Type="VI" URL="../Stim Loop/Running Event Handler.vi"/>
			<Item Name="Update Stim Status Indicators.vi" Type="VI" URL="../Stim Loop/Update Stim Status Indicators.vi"/>
			<Item Name="WRAPPER Stop Log and Sequence.vi" Type="VI" URL="../Stim Loop/WRAPPER Stop Log and Sequence.vi"/>
			<Item Name="Send New Test Record.vi" Type="VI" URL="../Stim Loop/Send New Test Record.vi"/>
			<Item Name="New TDMS Log File Path.vi" Type="VI" URL="../Stim Loop/New TDMS Log File Path.vi"/>
			<Item Name="Clear dummy fault.vi" Type="VI" URL="../Stim Loop/Clear dummy fault.vi"/>
			<Item Name="Apply dummy fault.vi" Type="VI" URL="../Stim Loop/Apply dummy fault.vi"/>
			<Item Name="Trigger DPL To Create Failure Log.vi" Type="VI" URL="../Stim Loop/Trigger DPL To Create Failure Log.vi"/>
		</Item>
		<Item Name="Top Level" Type="Folder">
			<Item Name="GUI Init.vi" Type="VI" URL="../Top Level/GUI Init.vi"/>
			<Item Name="Initialize.vi" Type="VI" URL="../Top Level/Initialize.vi"/>
			<Item Name="Read Config File.vi" Type="VI" URL="../Top Level/Read Config File.vi"/>
			<Item Name="Shut down.vi" Type="VI" URL="../Top Level/Shut down.vi"/>
		</Item>
		<Item Name="CSV Player With PtByPt Reporting.vi" Type="VI" URL="../CSV Player With PtByPt Reporting.vi"/>
		<Item Name="Development TODO List.rtf" Type="Document" URL="../Development TODO List.rtf"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Exe" Type="EXE">
				<Property Name="App_INI_aliasGUID" Type="Str">{75FB1A1F-8A18-4223-A2B8-E55D7B402899}</Property>
				<Property Name="App_INI_GUID" Type="Str">{7AA16D5F-FC65-4A07-89C9-DFBD9CE5B92D}</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{6ACABD00-9AD8-43E1-92F2-79267C2648A9}</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{2B182F43-CADD-4AC2-8770-E54F15367273}</Property>
				<Property Name="Destination[0].destName" Type="Str">CSV Player With PtByPt Reporting.exe</Property>
				<Property Name="Destination[0].path" Type="Path">../Built/CSV Player With PtByPt Reporting.exe</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">../Built/data</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Source[0].itemID" Type="Str">{8987A18D-9890-4A26-9070-0432E2E5C85F}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/CSV Player With PtByPt Reporting.vi</Property>
				...
				<Property Name="TgtF_targetfileGUID" Type="Str">{1AE09ED2-2DBD-4CC4-95BA-378A0B38A387}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">CSV Player With PtByPt Reporting.exe</Property>
			</Item>
		</Item>
	</Item>
</Project>
